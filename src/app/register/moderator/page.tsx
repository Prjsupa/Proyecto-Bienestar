...
export default function RegisterModeratorPage() {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-secondary p-4">
        <Alert variant="destructive" className="max-w-md">
            ...
            <AlertDescription>
                El registro para moderadores no se encuentra activo en este momento. Por favor, contacta a un administrador.
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-secondary p-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="text-2xl font-headline">Registro de Moderadores</CardTitle>
          <CardDescription>
            Únete al equipo de moderación de la plataforma.
          </CardDescription>
        </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <CardFooter className="flex-col gap-4">
                <Button type="submit" className="w-full bg-primary text-primary-foreground hover:bg-primary/90" disabled={form.formState.isSubmitting}>
                   {form.formState.isSubmitting ? "Registrando..." : "Registrarse como Moderador"}
                </Button>
