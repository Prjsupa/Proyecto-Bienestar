...
import { Clock, Barbell } from 'lucide-react';
  ...
  return (
    <Card className="overflow-hidden flex flex-col group h-full transition-shadow hover:shadow-lg">
      ...
      <CardContent className="p-4 flex-grow flex flex-col">
        <CardTitle className="font-headline text-lg mb-2">{routine.title}</CardTitle>
      ...
      <CardFooter className="p-4 pt-0 mt-2">
         <Badge variant="outline" className="w-full justify-center">
            <Barbell className="w-3 h-3 mr-2 text-primary" />
            Ver Rutina
        </Badge>
      </CardFooter>
    </Card>
